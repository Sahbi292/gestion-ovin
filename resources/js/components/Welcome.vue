...
<template>
<!-- HK Wrapper -->
<div class="hk-wrapper hk-nav-alt">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown show-on-hover active">
                ...
                <div class="dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                    ...
                    <a class="dropdown-item active" href="sujet">Sujet</a>
...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header align-items-top">
            ...
            <div class="d-flex">
                <button class="btn btn-sm btn-outline-light btn-wth-icon icon-wthot-bg mr-15 mb-15"><span class="icon-label"><i class="fa fa-download"></i> </span><span class="btn-text">Export CSV </span></button>
                <button class="btn btn-sm btn-outline-light btn-wth-icon icon-wthot-bg mr-15 mb-15"><span class="icon-label"><i class="fa fa-share"></i> </span><span class="btn-text">Share </span></button>
                <button class="btn btn-sm btn-danger btn-wth-icon icon-wthot-bg mb-15"><span class="icon-label"><i class="fa fa-eye"></i> </span><span class="btn-text">Watch </span></button>
            </div>
        </div>
        <!-- /Title -->
        <!-- Row -->
